  ...
  return (
    ...
    >
      ...
      <TextInput
        ...
        value={
          paramType === "ENUM"
            ? cutEnumString(paramName)
            : paramName
        }
        onChangeText={(text) => {
          const clean = sanitize(text);
          if (paramType === "ENUM") {
            onNameChange(updateEnumParamName(clean));
          } else {
            onNameChange(clean);
          }
        }}
...
const styles = StyleSheet.create({
  container: {
    backgroundColor: "#fff", // wird durch Theme überschrieben
    borderRadius: 8,
    paddingVertical: 8,
  ...
  segmentedButtons: {
    alignSelf: "center",
    transform: [{ scaleX: 0.8 }, { scaleY: 0.8 }], // leicht verkleinern
    marginBottom: 3,
  },
  segmentedButtonItem: {
    minWidth: 80,
